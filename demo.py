...
from ldivider.ld_processor import (
    get_base,
    get_normal_layer,
    get_composite_layer,
    get_seg_base,
...
class webui:
    ...
    def segment_divide(
        ...
        if layer_mode == "composite":
            (
                ...
                addition_layer_list,
                subtract_layer_list,
            ) = get_composite_layer(self.input_image, df)
            filename = save_psd(
                self.input_image,
                [
                    base_layer_list,
    ...
    def launch(self, share):
        with self.demo:
            with gr.Row():
                with gr.Column():
                    ...
                    divide_mode = gr.Dropdown(
                        ["segment_mode", "color_base_mode"],
                        value="segment_mode",
        ...
        self.demo.queue()
        self.demo.launch(share=share, server_port=6006)
